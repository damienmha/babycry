...
As an investigation into flawed statistical methodologies, we also conducted an analysis wherein we acted as "bad statisticians/bad data scientists" to compare and contrast the results to our properly performed study. This included methodologies such as including the junk cries in our models, modelling parameters on all data including the test data, and cherry picking features to achieve better accuracy. This inclusion of bad statistics and data science becomes relevant when we note some of the findings from our literature review, such as the 100% accuracies and failure to report cross validation
